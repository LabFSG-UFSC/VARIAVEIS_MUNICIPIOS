...
TIPO_POR_VARIAVEL = {
    ...
    "indice_conectividade": "indice_normalizado",
    "cobertura_pop_4g5g": "indice_normalizado",
    "densidade_smp": "indice_normalizado",
    "hhi_smp": "indice_normalizado",
    "densidade_scm": "indice_normalizado",
    "hhi_scm": "indice_normalizado",
    "adensamento_estacoes": "indice_normalizado",
    "fibra": "indice_normalizado",
    "cobertura_area_agricultavel": "indice_normalizado",
    "desloc_trab_ate_5min_2022": "contagem",
    "desloc_trab_6a15min_2022": "contagem",
    "desloc_trab_15a30min_2022": "contagem",
    "desloc_trab_30a60min_2022": "contagem",
    "desloc_trab_1a2h_2022": "contagem",
    "desloc_trab_2a4h_2022": "contagem",
    "desloc_trab_mais_4h_2022": "contagem",
    "transp_trab_pe": "contagem",
    "transp_trab_bicicleta": "contagem",
    "transp_trab_motocicleta": "contagem",
    "transp_trab_automovel": "contagem",
    "transp_trab_onibus": "contagem",
    "transp_trab_trem_metro": "contagem",
    "transp_trab_outros": "contagem",
}
...
FONTE_PADRAO = {
    ...
    "bronze/IBC_municipios_indicadores_normalizados.csv": "IBC - Indicadores municipais normalizados",
    "bronze/tabela10330.csv": "IBGE - Tabela 10330",
    "bronze/tabela10332.csv": "IBGE - Tabela 10332",
}
...
METADADOS = [
    ...
    {
        "variavel_v14": "indice_conectividade",
        "variavel_original": "IBC",
        "descricao_original": "Indice Brasileiro de Conectividade municipal normalizado.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Corresponde ao Indice Brasileiro de Conectividade. Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "cobertura_pop_4g5g",
        "variavel_original": "Cobertura Pop. 4G5G",
        "descricao_original": "Indicador normalizado de cobertura populacional de redes 4G e 5G no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "densidade_smp",
        "variavel_original": "Densidade SMP",
        "descricao_original": "Indicador normalizado de densidade de SMP no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "hhi_smp",
        "variavel_original": "HHI SMP",
        "descricao_original": "Indicador normalizado de concentracao HHI do SMP no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "densidade_scm",
        "variavel_original": "Densidade SCM",
        "descricao_original": "Indicador normalizado de densidade de SCM no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "hhi_scm",
        "variavel_original": "HHI SCM",
        "descricao_original": "Indicador normalizado de concentracao HHI do SCM no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "adensamento_estacoes",
        "variavel_original": "Adensamento Estações",
        "descricao_original": "Indicador normalizado de adensamento de estacoes no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "fibra",
        "variavel_original": "Fibra",
        "descricao_original": "Indicador normalizado de oferta ou presenca de fibra no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente.",
    },
    {
        "variavel_v14": "cobertura_area_agricultavel",
        "variavel_original": "Cobertura área agricultável",
        "descricao_original": "Indicador normalizado de cobertura em area agricultavel no municipio.",
        "ano_referencia": "2024",
        "fonte_original": "bronze/IBC_municipios_indicadores_normalizados.csv",
        "observacoes": "Derivada da base de indicadores municipais normalizados do IBC. Quando ha mais de um ano no arquivo, o merge usa o ano mais recente e converte valores textuais com virgula decimal para numero.",
    },
    {
        "variavel_v14": "desloc_trab_ate_5min_2022",
        "variavel_original": "Até cinco minutos",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais na faixa de distancia habitual ao trabalho principal correspondente a ate cinco minutos de deslocamento.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10330.csv",
        "observacoes": "Derivada da Tabela 10330 do IBGE no recorte Total para cor ou raca e Total para local do exercicio do trabalho principal. Representa a distancia habitual ao trabalho principal em faixas de tempo de deslocamento.",
    },
    {
        "variavel_v14": "desloc_trab_6a15min_2022",
        "variavel_original": "De seis minutos até quinze minutos",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais na faixa de distancia habitual ao trabalho principal correspondente a seis a quinze minutos de deslocamento.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10330.csv",
        "observacoes": "Derivada da Tabela 10330 do IBGE no recorte Total para cor ou raca e Total para local do exercicio do trabalho principal. Representa a distancia habitual ao trabalho principal em faixas de tempo de deslocamento.",
    },
    {
        "variavel_v14": "desloc_trab_15a30min_2022",
        "variavel_original": "Mais de quinze minutos até meia hora",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais na faixa de distancia habitual ao trabalho principal correspondente a mais de quinze minutos ate meia hora de deslocamento.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10330.csv",
        "observacoes": "Derivada da Tabela 10330 do IBGE no recorte Total para cor ou raca e Total para local do exercicio do trabalho principal. Representa a distancia habitual ao trabalho principal em faixas de tempo de deslocamento.",
    },
    {
        "variavel_v14": "desloc_trab_30a60min_2022",
        "variavel_original": "Mais de meia hora até uma hora",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais na faixa de distancia habitual ao trabalho principal correspondente a mais de meia hora ate uma hora de deslocamento.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10330.csv",
        "observacoes": "Derivada da Tabela 10330 do IBGE no recorte Total para cor ou raca e Total para local do exercicio do trabalho principal. Representa a distancia habitual ao trabalho principal em faixas de tempo de deslocamento.",
    },
    {
        "variavel_v14": "desloc_trab_1a2h_2022",
        "variavel_original": "Mais de uma hora até duas horas",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais na faixa de distancia habitual ao trabalho principal correspondente a mais de uma hora ate duas horas de deslocamento.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10330.csv",
        "observacoes": "Derivada da Tabela 10330 do IBGE no recorte Total para cor ou raca e Total para local do exercicio do trabalho principal. Representa a distancia habitual ao trabalho principal em faixas de tempo de deslocamento.",
    },
    {
        "variavel_v14": "desloc_trab_2a4h_2022",
        "variavel_original": "Mais de duas horas até quatro horas",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais na faixa de distancia habitual ao trabalho principal correspondente a mais de duas horas ate quatro horas de deslocamento.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10330.csv",
        "observacoes": "Derivada da Tabela 10330 do IBGE no recorte Total para cor ou raca e Total para local do exercicio do trabalho principal. Representa a distancia habitual ao trabalho principal em faixas de tempo de deslocamento.",
    },
    {
        "variavel_v14": "desloc_trab_mais_4h_2022",
        "variavel_original": "Mais de quatro horas",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais na faixa de distancia habitual ao trabalho principal correspondente a mais de quatro horas de deslocamento.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10330.csv",
        "observacoes": "Derivada da Tabela 10330 do IBGE no recorte Total para cor ou raca e Total para local do exercicio do trabalho principal. Representa a distancia habitual ao trabalho principal em faixas de tempo de deslocamento.",
    },
    {
        "variavel_v14": "transp_trab_pe",
        "variavel_original": "A pé",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais cujo meio de transporte em que passam mais tempo para chegar ao trabalho principal e a pe.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10332.csv",
        "observacoes": "Derivada da Tabela 10332 do IBGE no recorte Total para cor ou raca.",
    },
    {
        "variavel_v14": "transp_trab_bicicleta",
        "variavel_original": "Bicicleta",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais cujo meio de transporte em que passam mais tempo para chegar ao trabalho principal e bicicleta.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10332.csv",
        "observacoes": "Derivada da Tabela 10332 do IBGE no recorte Total para cor ou raca.",
    },
    {
        "variavel_v14": "transp_trab_motocicleta",
        "variavel_original": "Motocicleta",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais cujo meio de transporte em que passam mais tempo para chegar ao trabalho principal e motocicleta.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10332.csv",
        "observacoes": "Derivada da Tabela 10332 do IBGE no recorte Total para cor ou raca.",
    },
    {
        "variavel_v14": "transp_trab_automovel",
        "variavel_original": "Automóvel",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais cujo meio de transporte em que passam mais tempo para chegar ao trabalho principal e automovel.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10332.csv",
        "observacoes": "Derivada da Tabela 10332 do IBGE no recorte Total para cor ou raca.",
    },
    {
        "variavel_v14": "transp_trab_onibus",
        "variavel_original": "Ônibus",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais cujo meio de transporte em que passam mais tempo para chegar ao trabalho principal e onibus.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10332.csv",
        "observacoes": "Derivada da Tabela 10332 do IBGE no recorte Total para cor ou raca.",
    },
    {
        "variavel_v14": "transp_trab_trem_metro",
        "variavel_original": "Trem ou metrô",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais cujo meio de transporte em que passam mais tempo para chegar ao trabalho principal e trem ou metro.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10332.csv",
        "observacoes": "Derivada da Tabela 10332 do IBGE no recorte Total para cor ou raca.",
    },
    {
        "variavel_v14": "transp_trab_outros",
        "variavel_original": "Outros",
        "descricao_original": "Numero de pessoas ocupadas de 10 anos ou mais cujo meio de transporte em que passam mais tempo para chegar ao trabalho principal se enquadra em outros meios.",
        "ano_referencia": "2022",
        "fonte_original": "bronze/tabela10332.csv",
        "observacoes": "Derivada da Tabela 10332 do IBGE no recorte Total para cor ou raca.",
    },
